...
Simple Django based Chat application for everyone that wants to learn how to create beginner Chat application.
...
```
git clone https://github.com/RalitsaTerzieva/django-chat-app
``` 
